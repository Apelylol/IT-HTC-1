...
- **ชื่อบอร์ด:** ITHTC13
- **สมาชิก + บทบาท (3H):**
  - 🛠️ **Hacker** (เทคนิค: ต่อบอร์ด/เก็บ data/train/deploy): Kittipruk Thongpetchan
  - 🎨 **Hipster** (ผู้ใช้: output ที่คนเข้าใจ/รูปแบบใช้งาน): Nakorn Chobkij
  - 📣 **Hustler** (คุณค่า: ปัญหา/ผู้ใช้/เล่าเดโม่): Wilasinee Urairat
